...
<body>
<!--  -->
<form id="userAction_save_do" name="Form1" action="${root}/editProduct" method="post">
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                <input type="text" name="pname" value="${requestScope.product.pname}" id="pname" class="bg"/>
            </td>
            <td width="18%" align="center" bgColor="#f5fafe" class="ta_01">
                是否热门：
            </td>
            <td class="ta_01" bgColor="#ffffff">
                ...
                <select name="isHot">
                    <option value="1" ${requestScope.product.isHot == 1 ? "selected = 'selected'" : ""}>是</option>
                    <option value="0" ${requestScope.product.isHot == 0 ? "selected = 'selected'" : ""}  >否</option>
                </select>
            </td>
        </tr>
        <tr>
